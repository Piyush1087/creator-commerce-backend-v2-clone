...
try {
  ...
  $flags = @('BRAND_INTELLIGENCE_DATABASE_TEST', 'BRAND_INTELLIGENCE_EXECUTION_DATABASE_TEST', 'BRAND_INTELLIGENCE_PROJECTION_DATABASE_TEST', 'BRAND_COMMUNICATION_DATABASE_TEST', 'BRAND_MEANING_DATABASE_TEST', 'BRAND_CHARACTER_DATABASE_TEST', 'AUDIENCE_PERSONA_DATABASE_TEST', 'BRAND_DIFFERENTIATION_DATABASE_TEST', 'VISUAL_STYLE_DATABASE_TEST', 'BRAND_CENTRE_DATABASE_TEST', 'GATEKEEPER_DATABASE_TEST')
