...
-- CreateEnum
CREATE TYPE "CollaborationStageStatus" AS ENUM ('NOT_STARTED', 'IN_PROGRESS', 'COMPLETED', 'SKIPPED', 'BLOCKED', 'HARD_STOPPED');

-- CreateEnum
CREATE TYPE "CollaborationNegotiationState" AS ENUM ('NOT_REQUIRED', 'AWAITING_BRAND_DECISION', 'AWAITING_CREATOR_DECISION', 'AGREED', 'DECLINED');

-- CreateEnum
CREATE TYPE "CollaborationPaymentRail" AS ENUM ('PLATFORM_ESCROW', 'MANUAL');

-- CreateEnum
CREATE TYPE "CollaborationSecurementState" AS ENUM ('NOT_REQUIRED', 'AWAITING_FUNDING', 'FUNDING_REQUESTED', 'FUNDED', 'AWAITING_MANUAL_PAYMENT', 'AWAITING_CREATOR_CONFIRMATION', 'DISPUTED', 'COMPLETED');

-- CreateEnum
CREATE TYPE "CollaborationFulfillmentState" AS ENUM ('NOT_REQUIRED', 'NOT_STARTED', 'AWAITING_BRAND_FULFILLMENT', 'AWAITING_CREATOR_CONFIRMATION', 'REMEDIATION_REQUIRED', 'COMPLETED', 'HARD_STOPPED');

-- CreateEnum
CREATE TYPE "CollaborationDeliverableState" AS ENUM ('AWAITING_SUBMISSION', 'UNDER_REVIEW', 'REVISION_REQUESTED', 'APPROVED', 'AUTO_APPROVED', 'HARD_STOPPED');

-- CreateEnum
CREATE TYPE "CollaborationPublishingState" AS ENUM ('PUBLISHING_NOT_REQUIRED', 'AWAITING_AUTHORIZATION', 'AWAITING_EVIDENCE', 'UNDER_REVIEW', 'CORRECTION_REQUIRED', 'VERIFIED', 'BLOCKED');

-- CreateEnum
CREATE TYPE "CollaborationPublicationAuthorizationState" AS ENUM ('NOT_REQUIRED', 'NOT_AUTHORIZED', 'AUTHORIZED');

-- CreateEnum
CREATE TYPE "CollaborationEventKind" AS ENUM ('CREATED', 'STATE_TRANSITION', 'COMMAND_ACCEPTED', 'SYSTEM_NOTE');
