-- Additive against developer-owned campaign Phase 1–3.
-- Skips UceApplication / UceCampaignCreator / UceApplicationSnapshot which already exist.
...
ALTER TABLE "uce_campaign_creators" ADD COLUMN "creator_user_id" TEXT;

ALTER TABLE "uce_applications"
ADD COLUMN "proposed_fee" DECIMAL(14,2),
ADD COLUMN "legacy_pipeline_collaboration_id" TEXT;
