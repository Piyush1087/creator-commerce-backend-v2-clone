...
| Duplicate persistence (UCE collab vs Collaboration) | Harmless retained schema (INV-13 writers `410`) | Tables kept. Register: `../14-migration-schema/retained-schema-register.md`. No drop |
