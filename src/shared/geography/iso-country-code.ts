// ISO 3166-1 alpha-2 assigned country codes. Keep geography validation shared;
// Billing must not create a separate country taxonomy.
...
export function isIso31661Alpha2CountryCode(value: string): boolean {
