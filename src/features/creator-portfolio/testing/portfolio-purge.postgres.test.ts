// Recovery harness: accepted Audience V1 assertions unchanged; only import and
// task-owned disposable route/flag adapted. The accepted predecessor file is untouched.
...
const enabled = process.env.CREATOR_PORTFOLIO_DATABASE_TEST === "true";
