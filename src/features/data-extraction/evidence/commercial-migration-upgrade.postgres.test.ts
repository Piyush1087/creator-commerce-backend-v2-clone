...
database("P2B-2 populated migration 51 to 52", () => {
  ...
  beforeAll(async () => {
    ...
    `;
    expect(Number(initial[0].count)).toBe(51);
  ...
  it("records migration 52 and installs all ten IDs in all seven checks", async () => {
