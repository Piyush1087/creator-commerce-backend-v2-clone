...
@Injectable()
export class CreatorPayoutsReadEnvironmentService {
  ...
  async assertDatabaseUtc(): Promise<void> {
    ...
    if (typeof value !== "string" || value.toUpperCase() !== "UTC") {
      throw new ServiceUnavailableException({
        code: "CREATOR_PAYOUTS_DATABASE_TIMEZONE_UNSAFE",
        message: "Creator Payouts reads require a UTC database session",
      });
    }
  }
}
