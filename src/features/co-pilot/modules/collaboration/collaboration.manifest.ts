...
export const COLLABORATION_FUNCTION_MANIFEST: CollaborationManifestEntry[] = [
  ...
  {
    tool: "collab.viewStageDetail",
    description:
      "Inspect stage artifacts (quote/offer amounts, escrow, tracking, submission, live post) from Collaboration thread detail — not chat transcript",
    persona: ["BRAND", "CREATOR"],
    stages: [
      UceMilestoneStage.STAGE_1_NEGOTIATION,
      UceMilestoneStage.STAGE_2_SECUREMENT,
  ...
  {
    tool: "collab.getPendingActions",
    description: "Brand-side pending actions / blockers for a thread",
    persona: ["BRAND"],
    stages: [
      UceMilestoneStage.STAGE_1_NEGOTIATION,
      UceMilestoneStage.STAGE_2_SECUREMENT,
  ...
  {
    tool: "collab.getQuoteDetails",
    description: "Quote / commercial amounts for a collaboration",
    persona: ["BRAND", "CREATOR"],
    stages: [
      UceMilestoneStage.STAGE_1_NEGOTIATION,
      UceMilestoneStage.STAGE_2_SECUREMENT,
  ...
  {
    tool: "collab.getShipmentDetails",
    description: "Logistics / tracking shipment details",
    persona: ["BRAND", "CREATOR"],
    stages: [UceMilestoneStage.STAGE_3_LOGISTICS],
    backendRoute: "GET /api/v1/collaboration/threads/:id",
    serviceMethod: "getThread",
  ...
  {
    tool: "collab.getContentSubmission",
    description: "Latest creator content submission",
    persona: ["BRAND", "CREATOR"],
    stages: [UceMilestoneStage.STAGE_4_CONTENT_REVIEW],
    backendRoute: "GET /api/v1/collaboration/threads/:id",
    serviceMethod: "getThread",
  ...
  {
    tool: "collab.getDeliverables",
    description: "Deliverables checklist for a collaboration",
    persona: ["BRAND", "CREATOR"],
    stages: [
      UceMilestoneStage.STAGE_3_LOGISTICS,
      UceMilestoneStage.STAGE_4_CONTENT_REVIEW,
  ...
  {
    tool: "collab.getTimeline",
    description: "Stage timeline / activity progress",
    persona: ["BRAND", "CREATOR"],
    stages: [
      UceMilestoneStage.STAGE_1_NEGOTIATION,
      UceMilestoneStage.STAGE_2_SECUREMENT,
  ...
  {
    tool: "collab.getCreatorProfile",
    description: "Creator identity on the collaboration thread",
    persona: ["BRAND"],
    stages: [
      UceMilestoneStage.STAGE_1_NEGOTIATION,
      UceMilestoneStage.STAGE_2_SECUREMENT,
  ...
  {
    tool: "collab.getConversationHistory",
    description: "Collaboration message history",
    persona: ["BRAND", "CREATOR"],
    stages: [
      UceMilestoneStage.STAGE_1_NEGOTIATION,
      UceMilestoneStage.STAGE_2_SECUREMENT,
    ...
    backendRoute: "GET /api/v1/collaboration/threads/:id/messages",
    serviceMethod: "listMessages",
    hitl: false,
    recoveryMode: "NONE",
  },
  {
    tool: "collab.getCollaborationAnalytics",
    description: "Aggregate collaboration counts by stage",
    persona: ["BRAND"],
    stages: [
      UceMilestoneStage.STAGE_1_NEGOTIATION,
      UceMilestoneStage.STAGE_2_SECUREMENT,
